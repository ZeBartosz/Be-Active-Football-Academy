...
export default function ProgramGroupIndex({ programGroups = [] }) {
    return (
        <>
                ...
                <div className="flex items-end justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-blue-200/80">
                            Explore our training pathways by age and ability.
                        </p>
                    </div>
                    <Link
                        href={route("home")}
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    <Link
                                        href={route("program_group.show", {
                                            programGroup: group.id,
                                        })}
